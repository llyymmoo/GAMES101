...
Eigen::Matrix4f get_model_matrix(float rotation_angle)
{
    ...
    // Then return it.
    model(0, 0) = cos(rotation_angle / 57.3);
    model(1, 1) = cos(rotation_angle / 57.3);
    model(0, 1) = -sin(rotation_angle / 57.3);
    model(1, 0) = sin(rotation_angle / 57.3);
